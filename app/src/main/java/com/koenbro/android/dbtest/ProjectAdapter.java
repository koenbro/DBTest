 ...
 * com.koenbro.android.dbtest.ProjectDBAdapter ProjectDBAdaptor} which handles the SQLite
 * database read, write operations.
 * @see com.koenbro.android.dbtest.ProjectDBAdapter
 */
class ProjectAdapter extends ArrayAdapter<Project> {
     ...
     *                          getAllProjects() from ProjectDBAdapter
     */
